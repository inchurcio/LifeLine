-- LifeLine Blood Bank Management System - Seed Data
...
-- NOTE: For security, you should register new accounts through the registration page.
-- The following are sample accounts for initial testing only.
-- All passwords below are: "Password123"
-- Valid bcrypt hash for Password123 (Generated locally)
